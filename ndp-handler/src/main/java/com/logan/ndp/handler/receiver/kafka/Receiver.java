package com.logan.ndp.handler.receiver.kafka;

import cn.hutool.core.collection.CollUtil;
import com.alibaba.fastjson.JSON;
import com.logan.ndp.common.enums.MessageQueuePipeline;
...
public class Receiver {
     ...
     * @param topicGroupId
     */
    @KafkaListener(topics = "#{'${ndp.business.topic.name}'}", containerFactory = "filterContainerFactory")
