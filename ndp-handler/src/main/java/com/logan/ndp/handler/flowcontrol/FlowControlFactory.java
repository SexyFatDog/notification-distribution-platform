...
import com.logan.ndp.handler.flowcontrol.annotations.LocalRateLimit;
...
public class FlowControlFactory implements ApplicationContextAware {
    ...
    private Double getRateLimitConfig(Integer channelCode) {
        String flowControlConfig = config.getProperty(FLOW_CONTROL_KEY, NDPConstant.EMPTY_JSON_OBJECT);
