...
import com.logan.ndp.common.enums.SmsStatus;
import com.logan.ndp.repository.domain.ChannelAccountDo;
import com.logan.ndp.repository.domain.MessageTemplateDo;
import com.logan.ndp.repository.domain.SmsRecord;
import com.logan.ndp.web.vo.amis.CommonAmisVo;
import com.logan.ndp.web.vo.amis.EchartsVo;
import com.logan.ndp.web.vo.amis.SmsTimeLineVo;
...
/**
 * front-end uses Baidu Amis framework
 * this class is for adapting to the Amis framework
 */
...
//    }
     ...
     * @return
     */
    public static List<CommonAmisVo> getChannelAccountVo(List<ChannelAccountDo> channelAccounts, Integer channelType) {
        ...
        for (ChannelAccountDo channelAccount : channelAccounts) {
     ...
     * @return
     */
    public static EchartsVo getEchartsVo(Map<Object, Object> anchorResult, MessageTemplateDo messageTemplate, String businessId) {
